#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""2026-W35 周复盘：刷新 dashboard-data.json（原子写入，2026-08-30）
口径：completed=0（本周无回写，不伪造）；overdue=date<今天且未完成且未归档；
phase-2 closed / phase-3 active；current_day=30（7/31 = day0）；total=205（含新生成 phase-3 t113-t205）
"""
...
db = {
    ...
    'progress': {
        ...
        'current_day': 30,
        'days_remaining': 118,
        'progress_percentage': round(30 / 148 * 100),
    },
    'tasks': {
        'total_tasks': total,
